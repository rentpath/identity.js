...
var access  = process.env['AWS_ACCESS_KEY']  || process.env['SERVICES_RENTPATHCODE_BUCKET_ACCESS_KEY'];
var bucket  = process.env['AWS_BUCKET_NAME'] || process.env['SERVICES_RENTPATHCODE_BUCKET_NAME'];
var exec    = require('child_process').exec;
var file    = require('file');
var pack    = require('./package.json');
var path    = require('path');
var prefix  = './node_modules/.bin/s3-cli put ./dist/';
var secret  = process.env['AWS_SECRET_KEY']  || process.env['SERVICES_RENTPATHCODE_BUCKET_SECRET_KEY'];
...
if ((typeof bucket == 'undefined') || (typeof access == 'undefined') ||
  ...
  console.log('  and/or rpenv SERVICES_RENTPATHCODE_BUCKET_ACCESS_KEY,');
  console.log('  SERVICES_RENTPATHCODE_BUCKET_NAME, and ');
  console.log('  SERVICES_RENTPATHCODE_BUCKET_SECRET_KEY.');
  process.exit();
}
